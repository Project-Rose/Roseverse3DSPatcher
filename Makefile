...
ROMFS		:=	romfs
GFXBUILD	:=	$(ROMFS)/gfx
APP_TITLE   :=  Roséverse Patcher
APP_DESCRIPTION :=  Install or remove Roséverse!
APP_AUTHOR  :=  Virtualle and ZeroSkill
ICON := meta/icon.png
...
LIBS	:= -lcurl -lmbedtls -lmbedx509 -lmbedcrypto -lz -lcitro2d -lcitro3d -lctru -lm `$(PREFIX)pkg-config opusfile --libs`
